...
if __name__ == "__main__":
    jsonl_paths = [
        os.path.join(PROJECT_DIR, 'data/RUOD/metadatas/data_setting1/test_novel_corals.jsonl'),
        os.path.join(PROJECT_DIR, 'data/RUOD/metadatas/data_setting1/test_novel_cuttlefish.jsonl'),
        os.path.join(PROJECT_DIR, 'data/RUOD/metadatas/data_setting1/test_novel_turtle.jsonl'),
        os.path.join(PROJECT_DIR, 'data/RUOD/metadatas/data_setting1/test_novel_jellyfish.jsonl')
    ]
    output_dir = os.path.join(PROJECT_DIR, "data/RUOD/bboxes")
